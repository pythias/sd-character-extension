...
gGPUUsedMemory.set_function(func=lambda: gpu_used_memory)
gGPUTotalMemory.set_function(func=lambda: gpu_total_memory)
gGPUTemperature.set_function(func=lambda: gpu_temperature)
