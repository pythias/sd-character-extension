...
def apply_t2i_upscale(request):
    ...
    lib.log(f"ENABLE-UPSCALE-t2i, scale:{request.hr_scale}, size:{lib.get_request_value(request, 'width', 512)}x{lib.get_request_value(request, 'height', 512)}, denoising:{request.denoising_strength}")
